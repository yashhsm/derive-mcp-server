...
export const getWithdrawalHistory: Action<typeof schema> = {
  name: "get_withdrawal_history",
  protocol: "derive",
  description: "Get withdrawal history for a subaccount.",
  schema,
  ...
  execute: async (params) => {
    ...
    return privateRequest("get_withdrawal_history", q);
  },
};
